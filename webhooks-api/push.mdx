...
![New OneSignal App](/images/new-onesignal-app.png)
...
![Web Configuration](/images/onesignal-web-configuration.png)
...
![OneSignal Code Snipped](/images/onsignal-snippet.png)
...
![OneSignal connect](/images/onesignal-connect.png)
...
![OneSignal Subscription](/images/onesignal-subscription.png)
...
The webhook can be created using the Avacloud portal or Glacier API. For convenience, we are going to use cURL. For that copy the forwarding URL generated by Ngrok and append the `/callbackpath` and our address.
```bash
...
![OneSigna notification](/images/onesignal-notification.png)
